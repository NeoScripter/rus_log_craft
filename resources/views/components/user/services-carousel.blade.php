@props(['total_slides' => 5, 'image_path' => ''])
...
<div x-data="{
    ...
    <div :style="{ transform: `translateX(-${currentSlide * 100}%)` }"
        ...
        @for ($i = 0; $i < $total_slides; $i++)
            <div class="basis-full shrink-0">
                <img class="object-cover object-center w-full h-full" src="{{ asset($image_path . $i + 1 . '.webp') }}"
    ...
    <div
        class="absolute items-center justify-between hidden h-10 sm:flex top-1/2 left-4 right-4">
